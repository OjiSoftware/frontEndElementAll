      ...
      >
        ...
        >
          ...
          <div className="mt-6 md:mt-8 flex justify-end border-t border-slate-700 pt-4 gap-2 md:gap-3">
            <button
              className="px-4 md:px-6 py-3 md:py-2 font-bold rounded-lg text-xs md:text-sm flex-1 md:flex-none border border-slate-600 text-slate-300 bg-transparent transition-all duration-300 cursor-pointer hover:bg-slate-500/20 hover:text-white hover:border-slate-400"
              onClick={onClose}
            >
              Cerrar
            </button>
