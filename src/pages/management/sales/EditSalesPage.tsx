        ...
        <div className="flex h-full flex-col items-center justify-center text-white gap-4 min-h-[60vh]">
          <div className="bg-slate-800/80 border border-white/20 p-8 rounded-2xl shadow-2xl backdrop-blur-md text-center space-y-4 max-w-md w-full">
            ...
            <button
              ...
              className="mt-4 px-6 py-2 rounded-lg bg-indigo-600 text-white font-bold hover:bg-indigo-500 transition cursor-pointer shadow-[0_0_15px_rgba(79,70,229,0.3)] w-full"
            >
              Volver a la tabla
            </button>
          </div>
                  ...
                  <div className="md:col-span-2 flex flex-col justify-end">
                    ...
                    >
                      <input
                        ...
                        className="w-3.5 h-3.5 rounded border-gray-500 text-indigo-500 bg-slate-800 cursor-pointer disabled:cursor-not-allowed"
                      />
